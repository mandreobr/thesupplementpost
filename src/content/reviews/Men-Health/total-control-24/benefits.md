...
<header class="mb-10 text-center">
  <h1 class="text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 mb-4 leading-tight">
    TC24 Benefits — What This Supplement Is Designed to Support
  </h1>
...
<div class="mini-toc">
  ...
  <ul class="mini-toc-list">
    ...
    <li><a href="#final-verdict">Final Verdict — Are TC24 Benefits Worth Considering?</a></li>
  </ul>
</div>
...
<section class="final-verdict" id="final-verdict">
  <h2 class="final-verdict-title">
    Final Verdict — Are TC24 Benefits Worth Considering?
  </h2>
